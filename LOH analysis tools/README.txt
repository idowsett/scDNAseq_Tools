This set of scripts produces, analyzes and graphs using four input files generated by the snakemake pipeline included in the Mutator Volatility Snakemaker Pipeline: 
